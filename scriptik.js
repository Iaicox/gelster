...
function specOpenTwo(){
    if (specOpenArrowTwo%2 == 0){
        ...
        document.getElementById('spec-treug-two').style.transform = 'rotate(180deg)';
        ...
        document.getElementById('spec-treug-two').style.transform = 'none';
...
let specOpenArrowThree = 0;
function specOpenThree(){
    if (specOpenArrowThree%2 == 0){
        document.getElementById('spec-more-text-three').innerHTML = 'скрыть характеристики';
        document.getElementById('spec-treug-three').style.transform = 'rotate(180deg)';
        document.getElementById('hidden-spec-three').style.display = 'flex';
        document.getElementById('hidden-spec-three').style.display = '-ms-flexbox';
        $('.gallery').toggleClass('table-act-height');
        $('.table').toggleClass('table-act');
        specOpenArrowThree++;
        return (specOpenArrowThree);
    } else{
        document.getElementById('spec-more-text-three').innerHTML = 'развернуть все характеристики';
        document.getElementById('spec-treug-three').style.transform = 'none';
        document.getElementById('hidden-spec-three').style.display = 'none';
        $('.gallery').removeClass('table-act-height');
        $('.table').removeClass('table-act');
        specOpenArrowThree++;
        return (specOpenArrowThree);
...
function open_form_service_one() {
    document.getElementById('service-closed_form_one').style.opacity = '1';
    document.getElementById('service-closed_form_one').style.height = '800px';
    document.getElementById('service-closed_form_one').style.width = '450px';
    document.getElementById('service-closed_form_one').style.display = 'block';
}

function close_form_service_one(){
    document.getElementById('service-closed_form_one').style.opacity = '0';
    document.getElementById('service-closed_form_one').style.height = '0';
    document.getElementById('service-closed_form_one').style.width = '0';
    document.getElementById('service-closed_form_one').style.display = 'none';
}
...
$(document).ready(function() {
    var scriptSwitch = document.documentElement.clientWidth;
        if (scriptSwitch < 350) {
            $('.table-spec-hidden').toggleClass('table-spec-hidden_switch_nonact');
        }
   });


$('.spec-open').click(function(e){
    e.preventDefault;
    $(this).toggleClass('spec-open_act');
    $('.treug-spec').toggleClass('treug-spec_act');
    var scriptSwitch = document.documentElement.clientWidth;
    if(scriptSwitch < 350){
        $('.table-spec-hidden').toggleClass('table-spec-hidden_switch_act');
    } else {
        $('.table-spec-hidden').toggleClass('table-spec-hidden_act');
    }
});

$('.open-width').click(function(e){
    e.preventDefault;
    $('.open-width-list').toggleClass('open-width-list_act');
});

$('#one-width-three').click(function(e){
    e.preventDefault;
    $('.table-three').addClass('table_act');
    $('.table-one').removeClass('table_act');
    $('.table-two').removeClass('table_act');
});
$('#two-width-three').click(function(e){
    e.preventDefault;
    $('.table-three').addClass('table_act');
    $('.table-one').removeClass('table_act');
    $('.table-two').removeClass('table_act');
...
$('#two-width-one').click(function(e){
    e.preventDefault;
    $('.table-two').removeClass('table_act');
    $('.table-three').removeClass('table_act');
    $('.table-one').addClass('table_act');
});
$('#three-width-one').click(function(e){
    e.preventDefault;
    $('.table-two').removeClass('table_act');
    $('.table-three').removeClass('table_act');
    $('.table-one').addClass('table_act');
...
$('#one-width-two').click(function(e){
    e.preventDefault;
    $('.table-two').addClass('table_act');
    $('.table-one').removeClass('table_act');
    $('.table-three').removeClass('table_act');
});
$('#three-width-two').click(function(e){
    e.preventDefault;
    $('.table-two').addClass('table_act');
    $('.table-one').removeClass('table_act');
    $('.table-three').removeClass('table_act');
...
var specClick = 0;
document.getElementById('spec-open').addEventListener('click', function(){
    if(specClick%2 == 0){
        document.getElementById('switch-text').innerHTML = 'скрыть характеристики';
        specClick++;
        return(specClick);
    } else{
        document.getElementById('switch-text').innerHTML = 'развернуть характеристики';
        specClick++;
        return(specClick);
    }
})
