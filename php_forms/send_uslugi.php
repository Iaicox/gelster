...
$message = "ФИО: ".$fio."<br> Телефон: ".$tel."<br> Город: ".$city."<br> Необходимая услуга: ".$service;
...
if ($send == 'true') {
    echo "<p class='window_zayavka'>Спасибо.<br>Ваша заявка отправлена.<br>В ближайшее время с вами свяжется наш менеджер.<br>Можете закрыть это окно.<br>Или <a class='usual_link' href='gelster.ru/new/index.html'>нажмите сюда</a>, чтобы вернуться на главную страницу.<br>Хорошего дня!<br>Страница будет закрыта через <span id='timer'></span> секунд.<br><a class='window_zayavka-btn' href='#' onclick='closeWindow()'><span>Закрыть страницу</span></a></p>";
} else {
